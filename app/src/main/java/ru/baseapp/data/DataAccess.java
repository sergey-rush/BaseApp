...
import ru.baseapp.core.Order;
import ru.baseapp.core.OrderItem;
import ru.baseapp.core.OrderStatus;
...
public abstract class DataAccess extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "BASEDB.db";
